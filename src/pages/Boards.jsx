...
import AsanaImportModal from "../components/boards/AsanaImportModal"; 
...
export default function Boards() {
  ...
  const [showAsanaImportModal, setShowAsanaImportModal] = useState(false); 
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
          ...
          <div className="flex gap-2">
            <Button 
              onClick={() => setShowAsanaImportModal(true)}
              variant="outline"
              className="bg-white hover:bg-gray-50 text-[#323338] rounded-lg h-10 px-5 font-medium text-sm shadow-sm transition-all border-[#E1E5F3]"
            >
              Import from Asana
            </Button>
            <Button 
        ...
        {/* Asana Import Modal */}
        <AsanaImportModal
          isOpen={showAsanaImportModal}
          onClose={() => setShowAsanaImportModal(false)}
