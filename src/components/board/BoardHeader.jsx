...
import {
  ...
  Clock, // NEW: Added Clock icon for time tracking
  X // NEW: Added X icon for closing modal
} from "lucide-react";
...
import TimeTracker from "../time/TimeTracker"; // NEW: Import TimeTracker component
...
export default function BoardHeader({
  ...
  onShowIntegrations,
  onShowAutomations,
  onShowAIChat, // Added new prop
  onUpdateTitle // NEW: Added onUpdateTitle prop
}) {
  ...
  const [showTimeTracker, setShowTimeTracker] = useState(false); // NEW: State for Time Tracker Modal
  ...
  const handleSaveTitle = () => {
    if (onUpdateTitle && editedTitle.trim() && editedTitle.trim() !== board.title) {
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button
                    variant="outline"
                    size="sm"
                    className="h-8 px-3 text-xs border-[#E1E5F3] hover:border-green-500"
                ...
                <TooltipContent>Start time tracking for this project</TooltipContent>
              </Tooltip>
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button
                    variant="outline"
                    size="sm"
                    className="h-8 px-3 text-xs border-[#E1E5F3] hover:border-blue-500 bg-gradient-to-r from-blue-50 to-purple-50 hover:from-blue-100 hover:to-purple-100 transition-all duration-200 relative"
                ...
                <TooltipContent>Chat with AI about this project</TooltipContent>
              </Tooltip>
          ...
          >
            ...
            >
              <div className="p-4 border-b border-gray-200 flex items-center justify-between">
                ...
                <Button variant="ghost" size="icon" onClick={() => setShowTimeTracker(false)}>
                  <X className="w-4 h-4" />
                </Button>
              </div>
              <div className="p-6">
                <TimeTracker board={board} onClose={() => setShowTimeTracker(false)} />
              </div>
            </motion.div>
          </motion.div>
        )}
